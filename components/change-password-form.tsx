...
export function ChangePasswordForm({ onSuccess }: ChangePasswordFormProps) {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-5" aria-label="Form đổi mật khẩu">
      {error && (
        <div className="rounded-lg bg-red-50 dark:bg-red-900/30 p-4 text-red-800 dark:text-red-200 text-sm border border-red-200 dark:border-red-800" role="alert" aria-live="assertive">
      ...
      {success && (
        <div className="rounded-lg bg-green-50 dark:bg-green-900/30 p-4 text-green-800 dark:text-green-200 text-sm border border-green-200 dark:border-green-800" role="status" aria-live="polite">
          <div className="flex items-center">
            <svg className="w-5 h-5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
      ...
      <div>
        <label htmlFor="current" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2" id="current-label">
          Mật khẩu hiện tại
        </label>
        <input
          id="current"
      ...
      <div>
        <label htmlFor="new" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2" id="new-label">
      ...
      <div>
        <label htmlFor="confirm" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2" id="confirm-label">
      ...
      <button
        type="submit"
        disabled={loading}
        aria-label={loading ? "Đang xử lý đổi mật khẩu" : "Đổi mật khẩu"}
