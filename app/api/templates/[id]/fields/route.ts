...
export async function GET(
  ...
  try {
    ...
    return handleApiError(error, 'GET /api/templates/[id]/fields', 'Failed to get fields')
  }
}
...
export async function POST(
  ...
  try {
    ...
    return handleApiError(error, 'POST /api/templates/[id]/fields', 'Failed to create field')
  }
}
...
export async function PATCH(
  ...
  try {
    ...
    return handleApiError(error, 'PATCH /api/templates/[id]/fields', 'Failed to update fields')
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return handleApiError(error, 'DELETE /api/templates/[id]/fields', 'Failed to delete field')
  }
}
